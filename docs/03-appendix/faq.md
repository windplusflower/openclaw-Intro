...
| 模型 | 输入价格 | 输出价格 | 备注 |
|------|---------|---------|------|
| 通义千问 Qwen-Max | ¥0.04/千tokens | ¥0.12/千tokens | 阿里云 |
| 通义千问 Qwen-Plus | ¥0.004/千tokens | ¥0.012/千tokens | 性价比高 |
| GPT-4o | $0.005/千tokens | $0.015/千tokens | OpenAI |
| GPT-4o-mini | $0.00015/千tokens | $0.0006/千tokens | 经济选择 |
| DeepSeek-V3 | ¥0.001/千tokens | ¥0.002/千tokens | 国产低价 |

**费用估算示例：**
- 一次典型对话：约 1000-3000 tokens
- 使用 Qwen-Plus：约 ¥0.01-0.05/次
- 每天 100 次对话：约 ¥1-5/天
- 每月费用：约 ¥30-150

**省钱技巧：**
1. 使用性价比高的模型（如 Qwen-Plus、GPT-4o-mini）
