...
| 💻 **AI 编辑器/IDE** | 集成 AI 的代码编辑器/终端工具 | Cursor、Claude Code、Windsurf、OpenCode |
| 🛠️ **AI 工具/协议** | AI 与外部交互的标准/工具 | MCP、Skill、CLI-Anything |
| 🏢 **公司/组织** | 开发这些技术的公司或组织 | HKUDS、Anthropic、OpenAI |
...
| 特性 | Cursor | Claude Code | OpenCode | Windsurf |
|------|--------|-------------|----------|----------|
| **类型** | 编辑器 | 命令行工具 | 命令行工具 | 编辑器 |
| **基础** | VS Code | 终端 | 终端 | 自研 |
| **AI** | 多模型 | 仅 Claude | 多模型 | Codeium |
| **价格** | $20/月 | 需 Claude 订阅 | 免费 | 免费 |
| **适合** | 程序员 | 命令行用户 | 程序员 | 程序员 |
...
**不需要**：Cursor、Claude Code、OpenCode（这些是编程用的）
...
- 命令行 → **Claude Code** 或 **OpenCode**
- 免费替代 → **GitHub Copilot**（免费版）或 **OpenCode**
...
### ❌ 误区 2："CLI-Anything 能让所有软件被 AI 控制吗？"
**正解**：不能！目前只能处理：
- ✅ 有源码的开源桌面软件
